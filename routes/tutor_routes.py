...
@tutor_bp.route('/pets', methods=['POST'])
def create_pet():
...
@tutor_bp.route('/pets', methods=['GET'])
def get_all_pets():
    pets = PetService.get_all_pets()
    return jsonify(pets), 200


@tutor_bp.route('/pets/<pet_id>', methods=['GET'])
...
@tutor_bp.route('/pets/<pet_id>', methods=['PUT'])
...
@tutor_bp.route('/pets/<pet_id>', methods=['DELETE'])
